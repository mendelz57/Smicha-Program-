    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-indigo-800">Smicha Program</h1>
          <p className="text-gray-500 mt-2">Start your 7-day free trial</p>
        </div>
        ...
        <div className="mt-4">
          ...
          <button
            ...
            className="w-full border border-gray-300 py-2 rounded-lg font-medium hover:bg-gray-50 flex items-center justify-center gap-2 transition"
          >
        ...
        <div className="mt-6 bg-indigo-50 rounded-lg p-4 text-sm text-indigo-700">
          ...
          <ul className="space-y-1">
            ...
            <li>✓ Full access to all 4 subjects</li>
            <li>✓ Then $300/month or $2,880/year</li>
          </ul>
        </div>
